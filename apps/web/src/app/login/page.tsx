  ...
  return (
    <section className="mx-auto grid max-w-6xl gap-8 px-5 py-10 sm:px-8 sm:py-14 lg:grid-cols-[0.95fr_1.05fr] lg:gap-12 lg:px-10 lg:py-20">
      <div className="flex flex-col justify-between gap-10 rounded-[2rem] bg-accent/45 p-7 sm:p-10 lg:p-12">
        <div>
          <h1 className="max-w-xl font-semibold text-4xl leading-[1.08] tracking-[-0.05em] sm:text-5xl">
            Your hairline, on your terms.
          </h1>
          <p className="mt-5 max-w-lg text-base text-muted-foreground leading-7">
            Keep the photos you take, look back when you choose, and decide what feels right for
            you.
          </p>
        </div>
        ...
        <ul className="grid gap-4 text-foreground text-sm leading-6">
          ...
          <li className="flex gap-3">
            <Check aria-hidden="true" className="mt-1 size-4 shrink-0 text-primary" />A photo never
